...
from vala._allie.data import UCITokenizer
...
def initialize_model(
    ...
    **kwargs: dict[str, Any],
    ...
    # NOTE (vala vendor): upstream wraps the model with optimum's
    # BetterTransformer here. We verified it is a no-op for loading (0
    # missing/unexpected) and produces bit-identical heads, so we drop it to
    # avoid the heavy `optimum` dependency. See vala/allie.py.
